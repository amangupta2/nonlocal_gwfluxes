...
log_filename=f"./icml_train_ann-cnn_3x3_regional_threads_4hl_hdim-2idim_restart_epoch_{init_epoch}_to_{init_epoch+nepochs-1}.txt"
def write_log(*args):
...
# ============================= 3x3 ===========================
tstart=time2()
# shuffle=False leads to much faster reading! Since 3x3 and 5x5 is slow, set this to False - even with num_workers > 0
# For 10 requested CPUs, 8 workers works realy well. Speed up of 4-5x
trainset1 = Dataset(files=train_files,domain='regional', stencil=3, manual_shuffle=False, batch_size=bs_train)
...
testset1 = Dataset(files=test_files, domain='regional', stencil=3, manual_shuffle=False, batch_size=bs_test)
...
file_prefix = "torch_saved_models/icml_global/3x3_era5_regional_threads_ann_cnn_leakyrelu_dropout0p1_cyclic_mseloss" 
#nepochs=50 #30
if restart:
