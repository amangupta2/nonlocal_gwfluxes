...
log_filename=f"./icml_train_ann-cnn_3x3_global_4hl_hdim-2idim_restart_epoch_{init_epoch}_to_{init_epoch+nepochs-1}.txt"
def write_log(*args):
...
# For ICML - for comparison with Attention U-Net baseline
test_files = [
    '/scratch/users/ag4680/training_data/era5/'+pref+'inputfeatures_u_v_theta_uw_vw_era5_training_data_hourly_2015_constant_mu_sigma_scaling05.nc',
         ]
...
file_prefix = "torch_saved_models/icml_global/3x3_era5_global_ann_cnn_leakyrelu_dropout0p1_cyclic_mseloss" 
#nepochs=50 #30
if restart:
