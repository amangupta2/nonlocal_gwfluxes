...
restart=True
init_epoch=36 # which epoch to resume from. Should have restart file from init_epoch-1 ready
nepochs=35

#log_filename=f"./icml_train_ann-cnn_1x1_global_4hl_hdim-2idim_restart_epoch_{init_epoch}_to_{init_epoch+nepochs-1}.txt"
log_filename=f"./icml_train_ann-cnn_1x1_global_8hl_morelayers_hdim-2idim_restart_epoch_{init_epoch}_to_{init_epoch+nepochs-1}.txt"
def write_log(*args):
...
write_log('In this Ablation study, total layers have been increased from 6 to 10, i.e., 4 hidden layers to 8 hidden layers (with dropout 0.2 and normal RMSE). Batch size reduced from 80 to 40')
...
class ANN_CNN(nn.Module):
    ...
    def __init__(self,idim, odim, hdim, stencil, dropout=0):
        ...
        self.bnorm10   = nn.BatchNorm1d(2*odim)
...
file_prefix = "torch_saved_models/icml_global/era5_global_ann_cnn_leakyrelu_morelayers_cyclic_mseloss"
#nepochs=50 #30
if restart:
