...
restart=True
init_epoch=70 # which epoch to resume from. Should have restart file from init_epoch-1 ready
nepochs=30
...
# removed March 2015 from training set because data appears to be corrupted
train_files = [
