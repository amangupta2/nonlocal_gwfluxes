...
from function_training import Inference_and_Save
...
if dropout==0:
    if teston=='ERA5':
        out=f'/scratch/users/ag4680/gw_inference_ncfiles/TLIFS_inference_{S[0]}_{test_years[0]}_{test_month}.nc'
    else:
        out=f'/scratch/users/ag4680/gw_inference_ncfiles/TLIFS_inference_{S[0]}_{test_years[0]}_{test_month}_testedonIFS.nc'
else:
    if teston=='ERA5':
        out=f'/scratch/users/ag4680/gw_inference_ncfiles/TLIFS_inference_{S[0]}_{test_years[0]}_{test_month}_dropoutON_{sys.argv[5]}.nc'
    else:
        out=f'/scratch/users/ag4680/gw_inference_ncfiles/TLIFS_inference_{S[0]}_{test_years[0]}_{test_month}_testedonIFS_dropoutON_{sys.argv[5]}.nc'
