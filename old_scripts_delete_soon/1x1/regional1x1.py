...
log_filename=f"./icml_train_ann-cnn_1x1_regional_{sys.argv[1]}_4hl_hdim-4idim_restart_epoch_{init_epoch}_to_{init_epoch+nepochs-1}.txt"
...
trainset1 = Dataset(files=train_files,domain='regional', region=rgn, stencil=1, manual_shuffle=False, batch_size=bs_train)
...
testset1 = Dataset(files=test_files, domain='regional', region=rgn, stencil=1, manual_shuffle=False, batch_size=bs_test)
...
file_prefix = f"torch_saved_models/regional_training/era5_regional_{sys.argv[1]}_ann_cnn_leakyrelu_dropout0p2_cyclic_mseloss" 
