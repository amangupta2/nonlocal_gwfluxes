# regional (8x8): 100 epochs with 8 workers in 24 hours
import math
import numpy as np
...
log_filename=f"./icml_train_ann-cnn_3x3_regional_10layers_hdim-2idim_restart_epoch_{init_epoch}_to_{init_epoch+nepochs-1}.txt"
def write_log(*args):
...
file_prefix = "torch_saved_models/icml_global/3x3_era5_regional_10layers_ann_cnn_leakyrelu_dropout0p1_cyclic_mseloss" 
#nepochs=50 #30
if restart:
