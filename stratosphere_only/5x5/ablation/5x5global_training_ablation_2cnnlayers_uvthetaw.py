...
file_prefix = "torch_saved_models/stratosphere_only/ablation/5x5_era5_global_ann_cnn_uvthetaw_uwvw_ablation_2cnnlayers_4idim_4hl_leakyrelu_dropout0p2_cyclic_mseloss" 
if restart:
    idim    = trainset1.idim
    odim    = trainset1.odim
    hdim    = 4*idim
